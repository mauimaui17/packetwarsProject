...
//		this.bground = new Background(new BackgroundImage(new Image("/images/spayce.gif",GameStage.WINDOW_WIDTH,GameStage.WINDOW_HEIGHT,false,false),BackgroundRepeat.REPEAT, BackgroundRepeat.NO_REPEAT, BackgroundPosition.DEFAULT,BackgroundSize.DEFAULT));
	...
	public void setStageComponents(Stage stage){
		...
		tfName.setPrefHeight(30.0f);
		tfName.setStyle("-fx-border-color: #000000; -fx-border-width: 2px; -fx-background-color: #ffffff; -fx-text-fill: #000000");
		...
		tfIpAddress.setPrefHeight(30.0f);
		tfIpAddress.setStyle("-fx-border-color: #000000; -fx-border-width: 2px; -fx-background-color: #ffffff; -fx-text-fill: #000000");
		tfPort = new TextField();
		tfPort.maxWidth(5);
		tfPort.setPrefHeight(30.0f);
		tfPort.setStyle("-fx-border-color: #000000; -fx-border-width: 2px; -fx-background-color: #ffffff; -fx-text-fill: #000000");
